...
void Checkbox::init() {
    ...
    Serial.println(String(name.c_str()) + " State is " + String(state));
    Serial.println(String(name.c_str()) + " linkBool is " + String(*linkBool));
...
void Checkbox::changeState() {
    ...
    insertAnimation(new Animation(&(this -> checkboxAni),INDENT , (this -> state ? 6 : 0), 100));
